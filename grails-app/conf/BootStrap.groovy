...
class BootStrap {
    ...
    def init = { servletContext ->
        if (!Role.findByAuthority("admin")) {
            ...
            User userAdmin = new User(username: "admin", password: "admin", contactNumber: "123456789", profile: Profile.Other).save(flush: true, failOnError: true)
        ...
        if (!Role.findByAuthority("hcp")) {
            User userHCP = new User(username: "hcp", password: "hcp", contactNumber: "223456789", profile: Profile.Other).save(flush: true, failOnError: true)
        ...
        if (!Role.findByAuthority("agent")) {
            User userAgent = new User(username: "agent", password: "agent", contactNumber: "323456789", profile: Profile.Other).save(flush: true)
