...
<div class="nav" role="navigation">
	<ul>
		<li><g:link action="showAgent"><g:message code="title.agent" default="Agent" /></g:link></li>
		<li><g:link controller="admin" action="showHCP"><g:message code="title.hcp" default="HCP" /></g:link></li>
